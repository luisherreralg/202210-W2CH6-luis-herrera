...
let letterInfoDisplay = document.getElementsByClassName('letter-info')[0].innerHTML;
...
const questions = [
    ...
    },
    {
        ...
        letterInfo: 'CON LA S',
        question:
            "Ser fantástico, mitad mujer y mitad pez.",
    },
    {
        letter: "t",
        answer: "tijeras",
    ...
    },
    {
        ...
        letterInfo: 'CON LA Y',
        question:
            "Nombre cariñoso y familiar para el abuelo.",
    },
    {
        letter: "z",
        answer: "zoologico",
    ...
    },
    {
        ...
        letterInfo: 'CON LA N',
        question:
            "Órgano del cuerpo humano que usamos para respirar.",
    },
    {
        letter: "ñ",
        answer: "mañana",
        ...
        letterInfo: 'CON LA Ñ',
        question:
            "Contiene la ñ: día después de hoy.",
    },
    {
        letter: "o",
        answer: "oviparos",
    ...
    },
    {
        ...
        letterInfo: 'CON LA Q',
        question:
            "Resultado de multiplicar 3 x 5. ",
    },
    {
        letter: "r",
        answer: "raiz",
    ...
    },
    {
        ...
        letterInfo: 'CON LA U',
        question:
            "Sinónimo de maquinar, tramar, conspirar.",
    },
    {
        letter: "v",
        answer: "volga",
    ...
    },
    {
        ...
        letterInfo: 'CON LA X',
        question:
            "Número ordinal que va después del quinto.",
    },
    {
        letter: "y",
        answer: "yegua",
    ...
    },
    {
        ...
        letterInfo: 'CON LA Z',
        question:
            "Vehículo parecido al globo pero con una bolsa alargada.",
    },]
]
...
const checkAnswer = (number) => {
    ...
    if (answer === questions[randomArray][number].answer) {
        document.getElementsByClassName(`${questions[randomArray][number].letter}`)[0].classList.remove('pasapalabra');
        document.getElementsByClassName(`${questions[randomArray][number].letter}`)[0].classList.remove('failed');
        document.getElementsByClassName(`${questions[randomArray][number].letter}`)[0].classList.add('successful');
        wordsNumLeft--;
        wordsNumSuccess++;
        document.getElementsByTagName('body')[0].style.background = 'radial-gradient(circle, rgba(2,0,36,1) -11%, rgba(0,0,0,1) 0%, rgba(0,255,70,1) 99%)';
        ...
        document.getElementsByClassName(`${questions[randomArray][number].letter}`)[0].classList.add('pasapalabra');
        document.getElementsByTagName('body')[0].style.background = 'radial-gradient(circle, rgb(187 187 187) 40%, rgb(255 255 255) 100%)';
        indexArray.push(number);
    } else {
        document.getElementsByClassName(`${questions[randomArray][number].letter}`)[0].classList.remove('pasapalabra');
        document.getElementsByClassName(`${questions[randomArray][number].letter}`)[0].classList.add('failed');
        document.getElementsByTagName('body')[0].style.background = 'radial-gradient(circle, rgba(2,0,36,1) -11%, rgba(0,0,0,1) 0%, rgba(255,0,0,1) 99%)';
        wordsNumFailed++;
        wordsNumLeft--;
        questions[0][number].status = true;
        questions[1][number].status = true;
...
const timerOut = () => {
    let interval = setInterval(() => {
        ...
        if (timer <= 0) {
            ...
            document.getElementsByClassName('modal-container')[0].style.background = 'transparent';
            document.getElementById('modal-text').innerHTML = `Se ha terminado el tiempo y has terminado la partida con ${wordsNumFailed} fallos y ${wordsNumSuccess} aciertos. Si quieres volver a jugar haz click en reiniciar.`;
            document.getElementsByClassName('modal')[0].style.background = 'linear-gradient( 135deg, #F97794 10%, #623AA2 100%)';
            closeModalButton.addEventListener('click', () => {
...
const checkIfWin = () => {
    ...
    document.getElementsByClassName('close-button')[0].innerHTML = 'Reiniciar'
    document.getElementsByClassName('modal-container')[0].style.background = 'transparent';
    document.getElementById('modal-text').innerHTML = `Has terminado la partida con ${wordsNumFailed} fallos y ${wordsNumSuccess} aciertos. Si quieres volver a jugar haz click en reiniciar.`;
    document.getElementsByClassName('modal')[0].style.background = 'linear-gradient( 135deg, #6B73FF 10%, #000DFF 100%)';
    closeModalButton.addEventListener('click', () => {
        document.location.reload(true);
    })
}
...
const printIfo = (number) => {
    ...
    document.getElementsByClassName('letter-info')[0].innerHTML = questions[randomArray][number].letterInfo;
    document.getElementById('question').innerHTML = questions[randomArray][number].question;
    document.getElementsByClassName(`${questions[randomArray][number].letter}`)[0].classList.add('focus');
